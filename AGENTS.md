...
- `useURDecoder` must latch completion until `reset()`; repeated final animated frames are common in camera scanning and should not trigger `onScan` twice after a successful decode.
